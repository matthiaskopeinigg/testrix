...
import type { TxSplitPaneLeafContext } from '@app/shared/components/chrome/tx-split-pane/tx-split-pane.component';
...
import { TxTabBarComponent } from '@app/shared/components/chrome/tx-tab-bar/tx-tab-bar.component';
import type { TxTabBarCrossDropEvent } from '@app/shared/components/chrome/tx-tab-bar/tx-tab-bar.component';
import type { TxTabBarItem } from '@app/shared/components/chrome/tx-tab/tx-tab.types';
import { TxWorkspaceTabSkeletonComponent } from '@app/shared/components/chrome/tx-workspace-tab-skeleton/tx-workspace-tab-skeleton.component';
import type { TxWorkspaceTabSkeletonVariant } from '@app/shared/components/chrome/tx-workspace-tab-skeleton/tx-workspace-tab-skeleton.component';
