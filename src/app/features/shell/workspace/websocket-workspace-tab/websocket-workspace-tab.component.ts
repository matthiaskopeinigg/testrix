...
import { TxKeyValueDescriptionListComponent } from '@app/shared/components/data/tx-key-value-description-list/tx-key-value-description-list.component';
import type { TxKeyValueDescriptionRow } from '@app/shared/components/data/tx-key-value-description-list/tx-key-value-description-list.types';
...
export class WebsocketWorkspaceTabComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      // Skip while a local description edit is pending save — store sync would
      // clobber spaces mid-typing and reset the caret.
