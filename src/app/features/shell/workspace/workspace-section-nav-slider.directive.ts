...
/**
 * Animated highlight pill that slides between active workspace section tabs.
 */
@Directive({
  selector: '[txWorkspaceSectionNav]',
  standalone: true,
})
export class WorkspaceSectionNavSliderDirective {
  readonly txWorkspaceSectionNav = input.required<string>();
  ...
  private ensureSlider(): void {
    ...
    slider.className = 'workspace-tab-section-nav__slider';
