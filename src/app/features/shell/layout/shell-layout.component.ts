...
import type { OnboardingCompletePayload } from '../../../shared/components/overlays/tx-layout-onboarding-overlay/tx-layout-onboarding-overlay.component';
...
import { TxErrorBannerComponent } from '../../../shared/components/feedback/tx-error-banner/tx-error-banner.component';
import { TxNotificationHostComponent } from '../../../shared/components/feedback/tx-notification-host/tx-notification-host.component';
import { TxSettingsPopupComponent } from '../../../shared/components/overlays/tx-settings-popup/tx-settings-popup.component';
import { TxHelpPopupComponent } from '../../../shared/components/overlays/tx-help-popup/tx-help-popup.component';
import { TxTeamsPanelComponent } from '../../../shared/components/data/tx-teams-panel/tx-teams-panel.component';
import { TxCommandPaletteComponent } from '../../../shared/components/overlays/tx-command-palette/tx-command-palette.component';
import { TxProfileSwitchOverlayComponent } from '../../../shared/components/overlays/tx-profile-switch-overlay/tx-profile-switch-overlay.component';
import { TxLayoutOnboardingOverlayComponent } from '../../../shared/components/overlays/tx-layout-onboarding-overlay/tx-layout-onboarding-overlay.component';
import { TxUpdateInstallOverlayComponent } from '../../../shared/components/overlays/tx-update-install-overlay/tx-update-install-overlay.component';
import { TxUpdateBannerComponent } from '../../../shared/components/feedback/tx-update-banner/tx-update-banner.component';
import { TxWindowTitlebarComponent } from '../../../shared/components/chrome/tx-window-titlebar/tx-window-titlebar.component';
import { TxImportExportDialogComponent } from '../../../shared/components/overlays/tx-import-export-dialog/tx-import-export-dialog.component';
import { TxBatchImportDialogComponent } from '../../../shared/components/overlays/tx-batch-import-dialog/tx-batch-import-dialog.component';
@Component({
