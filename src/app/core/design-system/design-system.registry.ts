...
export const DESIGN_SYSTEM_COMPONENTS: readonly DesignSystemComponentEntry[] = [
  {
    ...
    label: 'Button',
    selector: 'tx-button',
    importPath: '@app/shared/components/forms/tx-button/tx-button.component',
  ...
  },
  {
    ...
    label: 'Icon',
    selector: 'tx-icon',
    importPath: '@app/shared/components/forms/tx-icon/tx-icon.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/forms/tx-form-field/tx-form-field.component',
  ...
  },
  {
    ...
    label: 'Modal',
    selector: 'tx-modal',
    importPath: '@app/shared/components/overlays/tx-modal/tx-modal.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/overlays/tx-help-popup/tx-help-popup.component',
    description:
  ...
  },
  {
    ...
    importPath: '@app/shared/components/overlays/tx-command-palette/tx-command-palette.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/feedback/tx-error-banner/tx-error-banner.component',
  ...
  },
  {
    ...
    label: 'Banner',
    selector: 'tx-banner',
    importPath: '@app/shared/components/feedback/tx-banner/tx-banner.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/feedback/tx-notification/tx-notification.component',
    description:
  ...
  },
  {
    ...
    importPath: '@app/shared/components/chrome/tx-brand-logo/tx-brand-logo.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/chrome/tx-window-titlebar/tx-window-titlebar.component',
  ...
  },
  {
    ...
    label: 'Input',
    selector: 'tx-input',
    importPath: '@app/shared/components/forms/tx-input/tx-input.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-variable-input/tx-variable-input.component',
    description:
  ...
  },
  {
    ...
    importPath: '@app/shared/components/forms/tx-dropdown/tx-dropdown.component',
    description:
  ...
  },
  {
    ...
    label: 'Tag',
    selector: 'tx-tag',
    importPath: '@app/shared/components/forms/tx-tag/tx-tag.component',
  ...
  },
  {
    ...
    label: 'Spinner',
    selector: 'tx-spinner',
    importPath: '@app/shared/components/feedback/tx-spinner/tx-spinner.component',
  ...
  },
  {
    ...
    label: 'Toggle',
    selector: 'tx-toggle',
    importPath: '@app/shared/components/forms/tx-toggle/tx-toggle.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/forms/tx-textarea/tx-textarea.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-code-editor/tx-code-editor.component',
    description:
  ...
  },
  {
    ...
    label: 'Slider',
    selector: 'tx-slider',
    importPath: '@app/shared/components/forms/tx-slider/tx-slider.component',
  ...
  },
  {
    ...
    label: 'Divider',
    selector: 'tx-divider',
    importPath: '@app/shared/components/forms/tx-divider/tx-divider.component',
  ...
  },
  {
    ...
    label: 'Tab',
    selector: 'tx-tab',
    importPath: '@app/shared/components/chrome/tx-tab/tx-tab.component',
  ...
  },
  {
    ...
    label: 'Tab bar',
    selector: 'tx-tab-bar',
    importPath: '@app/shared/components/chrome/tx-tab-bar/tx-tab-bar.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/chrome/tx-split-pane/tx-split-pane.component',
  ...
  },
  {
    ...
    label: 'Tooltip',
    selector: 'tx-tooltip',
    importPath: '@app/shared/components/overlays/tx-tooltip/tx-tooltip.component',
    description:
  ...
  },
  {
    ...
    label: 'Sidebar',
    selector: 'tx-sidebar',
    importPath: '@app/shared/components/chrome/tx-sidebar/tx-sidebar.component',
    description:
  ...
  },
  {
    ...
    importPath: '@app/shared/components/chrome/tx-theme-layout-preview/tx-theme-layout-preview.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-response-viewer/tx-response-viewer.component',
    description:
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-response-tab-bar/tx-response-tab-bar.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-response-status-strip/tx-response-status-strip.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/chrome/tx-vertical-split-pane/tx-vertical-split-pane.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-diff-view/tx-diff-view.component',
  ...
  },
  {
    ...
    importPath: '@app/shared/components/editors/tx-run-timeline/tx-run-timeline.component',
...
export const DESIGN_SYSTEM_PATTERNS: readonly DesignSystemPatternEntry[] = [
  ...
  },
  {
    ...
    scssPartial: 'src/app/shared/components/overlays/tx-modal/tx-modal.component.scss',
